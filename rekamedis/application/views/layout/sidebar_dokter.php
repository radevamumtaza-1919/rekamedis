...
<nav class="main-header navbar navbar-expand navbar-primary navbar-dark">
  <div class="container-fluid">
    <!-- Logo Lab -->
    <span class="fw-bold text-dark ms-1">Hallo Dokter</span>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="<?= site_url('dashboard_dokter') ?>" class="brand-link">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-3">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview">
        ...
        <li class="nav-item">
          <a href="<?= site_url('dashboard_dokter') ?>" class="nav-link <?= $this->uri->segment(1) == 'dashboard_dokter' ? 'active' : '' ?>">
