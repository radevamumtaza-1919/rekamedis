<div class="content-wrapper px-4 pt-4">
  ...
  <h3 class="text-dark fw-bold mb-4 d-flex justify-content-between align-items-center">
    <span>DATA PETUGAS VALIDASI KLINIK</span>
  ...
  <div class="mb-3">
    <a href="<?= site_url('petugas_validasi/create') ?>" class="btn btn-primary">
  ...
  <div class="card shadow-sm w-100">
    <div class="card-body table-responsive p-3">
      ...
      <table id="tabel-validasi" class="table table-bordered table-striped table-hover nowrap" style="width:100%">
        ...
        <tbody>
            ...
            <?php $no = 1; foreach ($petugas as $p): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= site_url('petugas_validasi/edit/'.$p->id_validasi) ?>" class="btn btn-sm btn-warning">
                    <i class="fas fa-edit"></i> Edit
                  </a>
                  <a href="<?= site_url('petugas_validasi/delete/'.$p->id_validasi) ?>"
          ...
          <?php else: ?>
            <tr>
              <td colspan="4" class="text-center text-muted">Belum ada data petugas validasi.</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
