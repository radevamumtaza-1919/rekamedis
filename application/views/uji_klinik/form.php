        ...
        <div class="card-body p-3 bg-white">
          <table class="table table-borderless align-middle mb-0 fs-6 text-dark">
            <tbody>
              ...
              <tr><td class="fw-semibold text-secondary"><strong>No. Telp</strong></td><td>: <?= isset($form->no_telp) ? $form->no_telp : '' ?></td></tr>
              <tr><td class="fw-semibold text-secondary"><strong>Alamat</strong></td><td>: <?= nl2br(isset($form->alamat) ? $form->alamat : '') ?></td></tr>
            </tbody>
          </table>
        </div>
      </div>
