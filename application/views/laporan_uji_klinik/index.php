...
?>
  ...
  <span>LAPORAN UJI LABORATORIUM KLINIK</span>
      ...
      <table id="tabel-permintaan" class="table table-bordered table-striped table-hover nowrap" style="width:100%">
        ...
        <tbody>
          <?php if (!empty($laporan)): ?>
            <?php $no = 1; foreach ($laporan as $f): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= site_url('laporan_uji_klinik/detail/'.$f->id) ?>" class="btn btn-sm btn-info">
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <tr><td colspan="7" class="text-center">Belum ada data laporan uji klinik.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
